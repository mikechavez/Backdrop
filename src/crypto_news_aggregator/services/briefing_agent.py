...
from crypto_news_aggregator.services.narrative_trust import (
    get_fresh_start_cutoff as get_shared_fresh_start_cutoff,
...
def get_fresh_start_cutoff() -> datetime:
    """Delegate to shared narrative_trust module."""
    return get_shared_fresh_start_cutoff()
...
def _is_narrative_summary_trusted(narrative: Dict[str, Any], cutoff: datetime) -> bool:
    """Delegate to shared narrative_trust module."""
    return is_narrative_summary_trusted(narrative, cutoff)
